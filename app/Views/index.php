                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="abt-col wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="200ms">
                            <img src="<?= base_url('assets/img/icon7.png') ?>" alt="">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="abt-col wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="400ms">
                            <img src="<?= base_url('assets/img/icon8.png') ?>" alt="">
                            <h3>Best Programm</h3>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="abt-col wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="600ms">
                            <img src="<?= base_url('assets/img/icon9.png') ?>" alt="">
                    ...
                    <div class="classes-col wow fadeInUp" data-wow-duration="1000ms">
                        <div class="class-thumb">
                            ...
                            <a href="contacts.html" title="" class="crt-btn">
                                <img src="<?= base_url('assets/img/icon10.png') ?>" alt="">
                            </a>
                        </div>
                    ...
                    <div class="teacher">
                        <div class="teacher-img">
                            ...
                            <div class="sc-div">
                                ...
                                <span><img src="<?= base_url('assets/img/plus.png') ?>" alt=""></span>
                            </div>
                        </div>
            ...
            <div class="col-lg-6">
                <div class="find-course">
                    <div class="sec-title">
                        ...
                        <h3><img src="<?= base_url('assets/img/icon11.png') ?>" alt="">Call: <strong>+2 342 5446 67</strong></h3>
                    </div><!--sec-title end-->
                    ...
                    <div class="course-card wow fadeInLeft" data-wow-duration="1000ms">
                        <div class="d-flex flex-wrap align-items-center">
                            <ul class="course-meta">
                                <li>
                                    <img src="<?= base_url('assets/img/icon12.png') ?>" alt="">
                                    29/07/2020
                                </li>
                                <li>
                                    11AM to 15PM
                        ...
                        <div class="d-flex flex-wrap">
                            ...
                            <span class="locat"><img src="<?= base_url('assets/img/loct.png') ?>" alt="" />43 castle road 517 district</span>
                        </div>
                    </div><!--course-card end-->
                    ...
                    <div class="blog-post">
                        ...
                        <div class="blog-info">
                            <ul class="meta">
                                ...
                                <li><img src="<?= base_url('assets/img/icon13.png') ?>" alt="" /><a href="#" title="">Teachers,</a><a href="#" title=""> School</a></li>
                            </ul>
