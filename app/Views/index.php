        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-5 col-md-5">
                <div class="banner-img wow zoomIn" data-wow-duration="1000ms">
                    <img src="<?= site_url('assets/ratb/img_1.png') ?>" alt="">
                </div><!--banner-img end-->
